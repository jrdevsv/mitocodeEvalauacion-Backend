...
public class SignosController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Signos> listarPorId(@PathVariable("id") Integer id) throws Exception{  //@RequestParam
		Signos obj = service.listarPorId(id);		
	...
	@PostMapping
	public ResponseEntity<Void> registrar(@Valid @RequestBody Signos signo) throws Exception{		
